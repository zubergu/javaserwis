...
public class ListUnfinishedOrders extends AbstractAction {
	private Orders orders;
	private JFrame frame;
	private JTable table;
	
	public ListUnfinishedOrders(Orders orders,JFrame frame, JTable table) {
		this.orders = orders;
		this.frame = frame;
		this.table = table;
	}
	...
	public void actionPerformed(ActionEvent arg0) {
        ...
        try {
				...
				String query = "select order_id from orders where order_status <> 'FINISHED'";
