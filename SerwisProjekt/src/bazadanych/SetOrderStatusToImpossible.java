...
public class SetOrderStatusToImpossible extends AbstractAction {
	private Orders orders;
	private JFrame frame;
	private JTable table;
	
	public SetOrderStatusToImpossible(Orders orders,JFrame frame, JTable table) {
		this.orders = orders;
		this.frame = frame;
		this.table = table;
	}
	...
	public void actionPerformed(ActionEvent arg0) {
        ...
        panel.add(new JLabel("Impossible order id:"));
        panel.add(field1);
        ...
        if (result == JOptionPane.OK_OPTION && !field1.getText().equals("")) {
			...
			try {
				...
				preparedStatement.setString(1,"IMPOSSIBLE");
				...
				model.setValueAt("IMPOSSIBLE", rowToChange, 4);
